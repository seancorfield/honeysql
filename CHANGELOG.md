...
* 2.7.1390 -- 2026-06-22
  * Expand suspicious character check and apply it to `sql-kw` to prevent SQL injection via `keyword` conversion of user input. Reported by [Younghun Ko](https://github.com/koyokr).
